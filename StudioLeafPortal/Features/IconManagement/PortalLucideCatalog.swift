...
enum PortalLucideCatalog {
    ...
    static let searchableIcons: [String] = [
        "a-arrow-down",
        "a-arrow-up",
        "a-large-small",
        "accessibility",
    ...
    static func filteredIcons(matching query: String) -> [String] {
        let trimmed = query.trimmingCharacters(in: .whitespacesAndNewlines)
        guard !trimmed.isEmpty else { return commonIcons }
        return Array(searchableIcons.filter { $0.localizedCaseInsensitiveContains(trimmed) }.prefix(searchResultLimit))
    }
}

...
enum PortalSymbolCatalog {
    ...
    static let searchableSymbols: [String] = [
        "0.circle",
        "0.circle.ar",
        "0.circle.fill",
        "0.circle.fill.ar",
    ...
    private static let searchResultLimit = 160

    static func filteredSymbols(matching query: String) -> [String] {
        let normalized = query.trimmingCharacters(in: .whitespacesAndNewlines).lowercased()
        guard !normalized.isEmpty else { return commonSymbols }
        return Array(searchableSymbols.filter { $0.lowercased().contains(normalized) }.prefix(searchResultLimit))
    }
}
